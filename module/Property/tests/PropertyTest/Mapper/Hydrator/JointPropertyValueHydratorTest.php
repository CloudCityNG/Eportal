...
class JointPropertyValueHydratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        ->getMock();
        $this->hydrator = new JointPropertyValueHydrator($this->service);
...
//        \Zend\Debug\Debug::dump($jpv);
    ...
    public function testExtract(){
        $object = new JointPropertyValue(1, $this->firstPropertyValue, $this->secondPropertyValue);
